...
public class MorseCodeController {
    ...
    //this way, we can easily look up the morse code for any given letter by the letter as the key

    //here I am declaring a hashmap to have a key of type "Character" with value of type "String"
    ...
    public void playSound(String[] morseMessage) throws InterruptedException, LineUnavailableException {
        //audion format specifies the audio properties(i.e. the type of sound we want)
    ...
    private void playBeep(SourceDataLine line, int duration){
        ...
        for (int i = 0; i<data.length; i++){
            ...
            //can represent both positive and negative amplitudes of sounds waves
